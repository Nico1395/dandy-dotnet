...
/// <remarks>
///     <para>
///         These extension methods provide strongly-typed and simplified ways to interact with the read-only
///         event store, including generic type support and stream replay utilities.
///     </para>
///     <para>
///         The <see cref="ReplayStreamAsync" /> method is particularly useful for rebuilding aggregate state,
///         as it automatically handles the snapshot and stream retrieval in a single call.
///     </para>
/// </remarks>
...
public static class ReadOnlyEventStoreExtensions
{
    ...
    ///     </para>
    ///     <para>
    ///         This is the most efficient way to rebuild aggregate state, as it minimizes the number of events
